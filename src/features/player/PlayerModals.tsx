...
interface PlayerModalsProps {
  ...
  onSettingChange: (
    key: Exclude<keyof SimulationSettings, 'showClosedTradeOverlays' | 'followCandle' | 'tradePanelTabPinned' | 'headerStatsVariant' | 'showTradingSessions' | 'showFairValueGaps' | 'ambiguousExitPolicy'>,
    value: number | null,
  ) => void;
